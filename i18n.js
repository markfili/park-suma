...
const STRINGS = {
  hr: {
    ...
    "title.share": "Podijeli statistiku", "title.help": "Pomoć i novosti",
    ...
    "goal.chip": "🎯 Cilj: {name}",
    "dist.title": "Parkovi u četvrti {d}",
    ...
    "together.title": "🤝 Igrajte zajedno",
    "together.intro": "Otvori sobu i podijeli kôd s prijateljima — gledajte napredak jedni drugih uživo dok skupljate park-šume. Veza ide izravno među preglednicima, bez servera.",
    "together.create": "➕ Otvori sobu", "together.join": "Pridruži se",
    "together.codePh": "KOD", "together.roomCode": "Kôd sobe:",
    "together.copyCode": "Kopiraj kôd", "together.codeCopied": "📋 Kôd kopiran",
    "together.leave": "🚪 Izađi", "together.you": "(ti)",
    ...
    "together.netErr": "Greška veze — pokušaj ponovno.",
    "together.hostLeft": "Domaćin je zatvorio sobu.",
    "together.peerJoined": "🤝 {name} se pridružio/la", "together.peerLeft": "👋 {name} je otišao/la",
    "together.visited": "🌲 {name} posjeti {park}!",
  ...
  en: {
    ...
    "title.share": "Share your stats", "title.help": "Help & what's new",
    ...
    "together.title": "🤝 Play together",
    "together.intro": "Open a room and share the code with friends — watch each other’s progress live as you collect park-šume. It connects browser-to-browser, no server.",
    "together.create": "➕ Open a room", "together.join": "Join",
    "together.codePh": "CODE", "together.roomCode": "Room code:",
    "together.copyCode": "Copy code", "together.codeCopied": "📋 Code copied",
    "together.leave": "🚪 Leave", "together.you": "(you)",
    ...
    "together.netErr": "Connection error — try again.",
    "together.hostLeft": "The host closed the room.",
    "together.peerJoined": "🤝 {name} joined", "together.peerLeft": "👋 {name} left",
    "together.visited": "🌲 {name} visited {park}!",
