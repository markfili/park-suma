...
const STRINGS = {
  hr: {
    ...
    "share.captionCopied": "📋 Opis kopiran — zalijepi u poruku",
    ...
    "help.badges": "🏅 Bedževi",
    "badge.unlocked": "Novi bedž: {name}!", "badge.count": "🏅 {n} / {t} bedževa",
    "badge.secretHint": "Tajni bedž — otkrij ga sam!",
    "badge.firstStep.name": "Prvi korak", "badge.firstStep.desc": "Prva prijava u park-šumu.",
    "badge.earlyBird.name": "Ranoranilac", "badge.earlyBird.desc": "Prijava prije 7 ujutro.",
    "badge.nightOwl.name": "Noćna sova", "badge.nightOwl.desc": "Prijava poslije 22 sata.",
    "badge.sprinter.name": "Šumski sprinter", "badge.sprinter.desc": "Tri parka u jednom danu.",
    "badge.giant.name": "Zagrljaj diva", "badge.giant.desc": "Posjećena Dotrščina, najveća (311 ha).",
    "badge.crumb.name": "Mrvica", "badge.crumb.desc": "Posjećen Susedgrad, najmanji (6,9 ha).",
    "badge.honor.name": "Na časnu riječ", "badge.honor.desc": "Pet prijava na povjerenje (bez GPS-a). Vjerujemo ti!",
    "badge.together.name": "Nismo sami", "badge.together.desc": "Igrali ste zajedno s prijateljem.",
    "badge.hedgehog.name": "Gdje je ježić?", "badge.hedgehog.desc": "Pronašao si skrivenog ježića! 🦔",
  ...
  en: {
    ...
    "share.captionCopied": "📋 Caption copied — paste into the message",
    ...
    "help.badges": "🏅 Badges",
    "badge.unlocked": "New badge: {name}!", "badge.count": "🏅 {n} / {t} badges",
    "badge.secretHint": "Secret badge — discover it yourself!",
    "badge.firstStep.name": "First step", "badge.firstStep.desc": "Your first park-šuma check-in.",
    "badge.earlyBird.name": "Early bird", "badge.earlyBird.desc": "Checked in before 7 a.m.",
    "badge.nightOwl.name": "Night owl", "badge.nightOwl.desc": "Checked in after 10 p.m.",
    "badge.sprinter.name": "Forest sprinter", "badge.sprinter.desc": "Three parks in a single day.",
    "badge.giant.name": "Hug the giant", "badge.giant.desc": "Visited Dotrščina, the largest (311 ha).",
    "badge.crumb.name": "The crumb", "badge.crumb.desc": "Visited Susedgrad, the smallest (6.9 ha).",
    "badge.honor.name": "Scout’s honor", "badge.honor.desc": "Five honor-mode check-ins (no GPS). We believe you!",
    "badge.together.name": "Not alone", "badge.together.desc": "Played together with a friend.",
    "badge.hedgehog.name": "Where’s the hedgehog?", "badge.hedgehog.desc": "You found the hidden hedgehog! 🦔",
